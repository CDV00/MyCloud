//using MyDrive.Command.Application.Abstractions;
using MyDrive.BuidingBlock.Contract.JsonConverters;
//using MyDrive.Command.Infrastructure.Authentication;
using MyDrive.Command.Infrastructure.PipeObservers;
using MyDrive.Command.Infrastructure.BackgroundJobs;
using MyDrive.Command.Infrastructure.Caching;
using MyDrive.Command.Infrastructure.DependencyInjection.Options;
using MassTransit;
...
namespace MyDrive.Command.Infrastructure.DependencyInjection.Extensions;
