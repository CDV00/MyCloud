        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParrentId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 50, nullable: true),
                    SortOrder = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Function_Function_ParrentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRoleClaim", x => x.RoleId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionInFunction", x => new { x.ActionId, x.FunctionId });
                    table.ForeignKey(
                        name: "FK_ActionInFunction_Action_ActionId",
                        column: x => x.ActionId,
                        principalTable: "Action",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActionInFunction_Function_FunctionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Permission", x => new { x.RoleId, x.FunctionId, x.ActionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionInFunction_FunctionId",
